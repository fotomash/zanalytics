...
class MicrostructureAnalyzer:
    ...
    def load_data(self):
        ...
        try:
            ...
            if self.limit_ticks:
                self.tick_df = self.tick_df.head(self.limit_ticks)
    ...
    def create_dashboard(self):
        ...
        import os
        # Extract trading pair name from file path
        pair_name = os.path.splitext(os.path.basename(self.tick_file_path))[0]
    ...
    def generate_report(self):
        ...
        import os
        from datetime import datetime
        pair_name = os.path.splitext(os.path.basename(self.tick_file_path))[0].upper()
