...
class WyckoffStateMachine:
    ...
    def process_event(self, event_type: str, index: int, zbars: List[ZBar]):
        ...
        if self.current_phase == WyckoffPhase.UNKNOWN:
            ...
            # Phase E begins after a convincing breakout above resistance.
            # A proper Back-Up (BU) that retests the breakout or a strong
            # Sign of Strength (SOS) closing above resistance can trigger it.
            if event_type == "BU":
                if (
