...
class ZanflowMaster:
    ...
    def fix_imports(self):
        ...
        import_mappings = {
            # Core imports
            'from data_manager import': 'from core.data_manager import',
            'from analysis_orchestrator import': 'from core.orchestration.analysis_orchestrator import',
            'import data_manager': 'from core import data_manager',

            # Analysis imports
            'from wyckoff_analysis import': 'from analysis.wyckoff_analysis import',
            'from midas_analysis import': 'from analysis.midas_analysis import',

            # Config imports
            'import config': 'from config import orchestrator_config',
            'from config import config': 'from config import orchestrator_config',

            # Dashboard imports
            'from dashboard_config import': 'from dashboards.config.dashboard_config import',
            'import dashboard_utils': 'from dashboards.utils import dashboard_utils',
        }
