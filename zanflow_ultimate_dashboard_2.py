...
# Enhanced Dashboard with Microstructure Analysis Integration
dashboard_code = '''
import streamlit as st
import pandas as pd
import numpy as np
...
with open('zanflow_microstructure_dashboard_enhanced.py', 'w', encoding='utf-8') as f:
    f.write(dashboard_code)

print("🎉 Created enhanced microstructure dashboard!")
print("\n🔧 New Features:")
print("✅ Auto-detects latest TXT/JSON analysis files")
print("✅ Displays microstructure analysis charts")
print("✅ Explains manipulation, SMC, and Wyckoff analysis")
print("✅ Provides clear trading recommendations")
print("✅ Shows detailed metrics and explanations")
print("✅ Supports multiple currency pairs")
print("✅ Auto-refresh capability")

print("\n📁 File Detection Pattern:")
print("- Searches current directory and ./data/{PAIR}/ folders")
print("- Finds *Microstructure_Analysis*Report*.txt files")
print("- Finds *Microstructure_Analysis*.json files") 
print("- Finds *Microstructure_Analysis*.png files")

print("\n🚀 To run:")
print("streamlit run zanflow_microstructure_dashboard_enhanced.py")