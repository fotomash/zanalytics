...
class CommandProcessor:
    ...
    async def _process_command_queue(self) -> None:
        ...
        while self.running:
            ...
            except Exception as e:  # pragma: no cover - redis/JSON errors
    ...
    async def _execute_agent_task(self, agent_name: str, task: Dict[str, Any], factory_class) -> None:
            ...
            try:
                ...
                for task_json in due_tasks:
                    ...
                    command = {
                        ...
                        "payload": task['params'],
                        "metadata": {"source": "scheduler", "scheduled_id": task['id']},
                    }
                    await self.dispatcher.process_command(command)
    ...
    def _extract_commands_from_text(self, text: str) -> List[Dict[str, Any]]:
        ...
        if "alert" in text.lower() or "notify" in text.lower():
            commands.append({
                ...
                "payload": {"level": "medium", "message": text},
            })
        return commands
