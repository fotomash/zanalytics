...
class TradeJournalistAgent:
    """Record trade decisions along with relevant analysis context."""
    ...
    def summary(self, entry: Dict[str, Any]) -> str:
        """Create a concise summary string for a log entry."""
        return (
    ...
    def log_decision(
        ...
        """Log a decision event and return the created entry."""
        entry: Dict[str, Any] = {
            ...
            "semantic_summary": (
                semantic_result.get("combined_interpretation") if semantic_result else None
            ),
    ...
    def get_latest_entry(self) -> Optional[Dict[str, Any]]:
        """Return the most recently logged entry or ``None``."""
